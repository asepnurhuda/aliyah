        ...
        <!-- form start -->
            ...
            @csrf
                <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                    ...
                    <input name="title" type="text" class="form-control" id="title" value="{{ $slider->title }}">
                    @if ( $errors->has('title') )
                ...
                <div class="form-group">
                    ...
                    <textarea name="content" type="text" class="form-control" id="editor">{{ $slider->content }}</textarea>
                </div>
