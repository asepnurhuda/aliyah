        ...
        <div class="card-body">
            ...
            @csrf
                ...
                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                    ...
                    <textarea name="description" class="form-control" id="editor1">{{ $event->description }}</textarea>
                ...
                <div class="form-group {{ $errors->has('date') ? 'has-error' : '' }}">
                    ...
                    <input type="date" name="date" class="form-control" value="{{ $event->date }}"></input>
                    @if ( $errors->has('date') )
                ...
                <div class="form-group {{ $errors->has('start') ? 'has-error' : '' }}">
                    ...
                    <input type="time" name="start" class="form-control" value="{{ $event->start }}"></input>
                    @if ( $errors->has('start') )
                ...
                <div class="form-group {{ $errors->has('finish') ? 'has-error' : '' }}">
                    ...
                    <input type="time" name="finish" class="form-control" value="{{ $event->finish }}"></input>
                ...
                <div class="form-group {{ $errors->has('room') ? 'has-error' : '' }}">
                    ...
                    <input name="room" class="form-control" value="{{ $event->room }}"></input>
                    @if ( $errors->has('room') )
                ...
                <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                    ...
                    <textarea name="address" class="form-control" id="editor2">{{ $event->address }}</textarea>
