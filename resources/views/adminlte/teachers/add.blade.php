        ...
        <form method="POST" action="{{ route('teachers.create') }}">
            ...
            @csrf
                ...
                <div class="form-group {{ $errors->has('biografi') ? 'has-error' : '' }}">
                    ...
                    <textarea name="biografi" class="form-control" id="editor1">{{ old('biografi') }}</textarea>
                ...
                <div class="form-group {{ $errors->has('fb') ? 'has-error' : '' }}">
                    ...
                    <input name="fb" class="form-control" value="{{ old('fb') }}"></input>
                    @if ( $errors->has('fb') )
                ...
                <div class="form-group {{ $errors->has('ig') ? 'has-error' : '' }}">
                    ...
                    <input name="ig" class="form-control" value="{{ old('ig') }}"></input>
                    @if ( $errors->has('ig') )
                ...
                <div class="form-group {{ $errors->has('linkedin') ? 'has-error' : '' }}">
                    ...
                    <input name="linkedin" class="form-control" value="{{ old('linkedin') }}"></input>
                ...
                <div class="form-group {{ $errors->has('deskripsi') ? 'has-error' : '' }}">
                    ...
                    <textarea name="deskripsi" class="form-control" id="editor2">{{ old('deskripsi') }}</textarea>
