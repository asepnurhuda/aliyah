...
<div class="col-12">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Tambah Pelajaran Baru</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form method="POST" action="{{ route('courses.create') }}">
            ...
            @csrf
                ...
                <div class="form-group {{ $errors->has('durasi') ? 'has-error' : '' }}">
                    ...
                    <input name="durasi" type="text" class="form-control" id="durasi" value="{{ old('durasi') }}">
                ...
                <div class="form-group {{ $errors->has('deskripsi') ? 'has-error' : '' }}">
                    ...
                    <textarea name="deskripsi" class="form-control" id="editor">{{ old('deskripsi') }}</textarea>
