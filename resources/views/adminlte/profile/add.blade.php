        ...
        <form method="POST" action="{{ route('profile.create') }}">
            ...
            @csrf
                <div class="form-group {{ $errors->has('sekilas') ? 'has-error' : '' }}">
                    ...
                    <textarea name="sekilas" type="text" class="form-control" id="editor1" value="{{ old('sekilas') }}"></textarea>
                ...
                <div class="form-group {{ $errors->has('pilih_kami') ? 'has-error' : '' }}">
                    ...
                    <textarea name="pilih_kami" type="text" class="form-control" id="editor2" value="{{ old('pilih_kami') }}"></textarea>
                ...
                <div class="form-group {{ $errors->has('visi') ? 'has-error' : '' }}">
                    ...
                    <textarea name="visi" type="text" class="form-control" value="{{ old('visi') }}"></textarea>
                    @if ( $errors->has('visi') )
                ...
                <div class="form-group {{ $errors->has('misi') ? 'has-error' : '' }}">
                    ...
                    <textarea name="misi" type="text" class="form-control" id="editor3" value="{{ old('misi') }}"></textarea>
                    @if ( $errors->has('misi') )
                ...
                <div class="form-group {{ $errors->has('tentang_kami') ? 'has-error' : '' }}">
                    ...
                    <textarea name="tentang_kami" type="text" class="form-control" id="editor4" value="{{ old('tentang_kami') }}"></textarea>
