          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <a href="{{ route('student.edit', $student->id) }}" class="btn btn-danger btn-block"><b>Lengkapi Formulir</b></a>
                @elseif ( $student->status == 'pendaftar' )
                <a href="{{ route('student.edit', $student->id) }}" class="btn btn-primary btn-block"><b>Edit Data</b></a>
                <a href="{{ route('student.ppdb', $student->id) }}" class="btn btn-success btn-block" onclick="return confirm('Pastikan data anda sudah lengkap!')"><b>Akhiri Pendaftaran</b></a>
                @elseif ( $student->status == 'peserta' )
                <a href="{{ route('student.exportpdf', $student->id) }}" class="btn btn-info btn-block"><b>Cetak Kartu Pendaftaran</b></a>
                @endif
              </div>
              <!-- /.card-body -->
            </div>
